...
const routineSlotSchema = new mongoose.Schema({
  ...
  labGroup: {
    ...
    enum: ['A', 'B', 'ALL', null],
    default: null
    // For distinguishing between Group A, Group B, or ALL (both groups)
  },
...
// Legacy indexes for backward compatibility - Updated to support multiple lab groups per slot
routineSlotSchema.index({ 
  programCode: 1, 
  semester: 1, 
  section: 1, 
